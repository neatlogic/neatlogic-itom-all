...
To use the source code files under the `cs` directory, you must hold a valid **NeatLogic Enterprise License**, which must explicitly grant access rights to such source code files. Detailed provisions are set forth in [NeatLogic Enterprise License](LICENSE.ee.md).
