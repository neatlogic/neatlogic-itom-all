...
CREATE TABLE `codehub_repository` (
  ...
  `main_branch` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '主干分支，git仓库默认master，svn仓库默认trunk',
  `app_module_id` bigint DEFAULT NULL COMMENT '关联模块id',
  `create_mode` enum('import','manual') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'import：导入，manual：手动创建',
  `fcd` timestamp NULL DEFAULT NULL COMMENT '创建时间',
  `lcd` timestamp NULL DEFAULT NULL COMMENT '最后编辑时间',
  `fcu` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '创建用户',
  `lcu` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '最后编辑用户',
  `description` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '仓库描述',
  `sync_status` enum('success','failed','none','running') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '同步状态，success：成功，failed：失败 , running: 正在做同步 , 初始化是none',
  `sync_time` timestamp NULL DEFAULT NULL COMMENT '最后同步时间',
  `app_system_id` bigint DEFAULT NULL COMMENT '关联系统id',
  `default_branch` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '默认分支,git仓库默认master，svn仓库默认trunk',
  `branches_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '分支路径',
  `tags_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '标签路径',
  `runner_id` bigint DEFAULT NULL COMMENT '节点id',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `codehub_repository_uk_name` (`name`) USING BTREE,
  KEY `idx_repo_service_uuid` (`repo_service_id`) USING BTREE,
  KEY `idx_subsystem_uuid` (`app_module_id`) USING BTREE
...
CREATE TABLE `codehub_repository_service` (
  ...
  `type` enum('gitlab','svn') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '仓库类型',
  `address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '服务地址',
  `username` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '用户名',
  `password` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '密码',
  `status` enum('success','failed','none') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'none' COMMENT '同步状态，success：成功，failed：失败',
  `codehub_agent_id` bigint DEFAULT NULL COMMENT '代码库服务代理id，关联codehub_agent的id字段',
  `fcd` timestamp NULL DEFAULT NULL COMMENT '创建时间',
  `lcd` timestamp NULL DEFAULT NULL COMMENT '最后修改时间',
  `fcu` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '创建用户',
  `lcu` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '最后修改用户',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `uk_name` (`name`) USING BTREE
